...
test() ->
    ...
    ClientSharedSecret = generate_shared_secret(ClientEphemeralSecret, ServerEphemeralPublicKey),
    ServerSharedSecret = generate_shared_secret(ServerEphemeralSecret, ClientEphemeralPublicKey),
